...
def cvss():
   ...
   if request.method=='POST': 
      ...
      access_complexity = float(request.form["access_complexity"])
      authentication = float(request.form["authentication"])
      confidentiality_impact = float(request.form["confidentiality_impact"])
      integrity_impact = float(request.form["integrity_impact"])
      availability_impact = float(request.form["availability_impact"])
